...
package API.Memberships is
	-- Types
	type Bungie_Platform_Type is (None, Xbox, PSN, Steam, Blizzard, Stadia, EGS, Demon, Next);
	...
	package GUIC_Vector is new Ada.Containers.Vectors (Natural, Group_User_Info_Card_Type);
	...
	type Membership_Type is record
		...
		Primary_Membership_ID : Unbounded_String := Null_Unbounded_String; -- For platform profile
