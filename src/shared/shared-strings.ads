...
package Shared.Strings is
	...
	function VS2UB (Item : VSS.Strings.Virtual_String'Class) return Unbounded_String renames VSS.Strings.Conversions.To_Unbounded_UTF_8_String;
	function VS2S (Item : VSS.Strings.Virtual_String'Class) return String renames VSS.Strings.Conversions.To_UTF_8_String ;
end Shared.Strings;
