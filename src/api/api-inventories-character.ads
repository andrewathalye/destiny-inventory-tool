...
package API.Inventories.Character is
	...
	procedure Add_Item (
		...
		Item : Manifest.Tools.Item_Description) with Inline;
	...
	function Character_Items (
		Inventory : Character_Inventory_Type;
		Character : Profiles.Character_Type) return Item_Description_List_Bucket_Location_Type_Array with Inline;
	
	function Equipped_Items (
		Inventory : Character_Inventory_Type;
		Character : Profiles.Character_Type) return Item_Description_Bucket_Location_Type_Array with Inline;
...
private
	package Item_Description_List_Bucket_Location_Type_Array_Maps is new Ada.Containers.Hashed_Maps (
	...
	package Item_Description_Bucket_Location_Type_Array_Maps is new Ada.Containers.Hashed_Maps (
		Key_Type => Unbounded_String,
		Element_Type => Item_Description_Bucket_Location_Type_Array,
		Hash => Shared.Strings.Hash,
		Equivalent_Keys => Shared.Strings.Equivalent_Keys);

	subtype Item_Description_List_Bucket_Location_Type_Array_Map is Item_Description_List_Bucket_Location_Type_Array_Maps.Map;
	subtype Item_Description_Bucket_Location_Type_Array_Map is Item_Description_Bucket_Location_Type_Array_Maps.Map;
