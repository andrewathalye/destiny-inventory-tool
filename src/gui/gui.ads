...
package GUI is
	...
	procedure Locked_Wrapper (Unsafe_Subprogram : Unsafe_Subprogram_Type) with Inline;

	-- A simple wrapper which perform an iteration of the Main Loop, locking the GUI first
	-- and then unlocking it afterwrads
	procedure Locking_Main_Iteration with Inline;
private
	use Ada.Streams;
	...
	function Load_Image (
		File_Name : String;
		Data : Stream_Element_Array) return Gdk_Pixbuf;
